...
myapp.controller('musicController', ['$scope', '$compile', '$timeout', function ($scope, $compile, $timeout) {
    ...
    $scope.music = [{
        artist: 'Cheb Houssem',
        img: 'Content/img/h.png',
        track: "Tiamo Tiamo",
        audio: 'Content/sounds/Tiamo_Tiamo.mp3',
        length: "5:31",
        startTime: '0',
        currTime: '0:00'
    }, {
        artist: 'Cheb Houssem',
        img: 'Content/img/h1.png',
        track: "Semhili Ya Ma",
        audio: 'Content/sounds/Semhili_Ya_Ma.mp3',
        length: "5:31",
        startTime: '0',
        currTime: '0:00'
    }, {
        ...
        audio: 'Content/sounds/Sayi_M3ak_Manzid.mp3',
        length: "5:31",
        startTime: '0',
        currTime: '0:00'
    }, {
        ...
        audio: 'Content/sounds/Ana_Sbabi_Bouha.mp3',
        length: "5:31",
        startTime: '0',
        currTime: '0:00'
    }
